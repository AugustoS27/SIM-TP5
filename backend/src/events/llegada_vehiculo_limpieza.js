...
export default function llegadaVehiculoLimpieza(vectorActual, vectorAnterior, reloj ,mediaLlegadaLimpieza, mediaFinLimpieza, limpieza) {
  ...
  if (limpieza.estado === "libre"){
    ...
    vehiculo = new Vehiculo(tipoVehiculo, "siendo limpiado", "limpieza" , reloj, reloj);

  } else{
    vehiculo = new Vehiculo(tipoVehiculo, "esperando limpieza", "limpieza", reloj);
