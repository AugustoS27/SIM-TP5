...
export default function llegadaVehiculoLavado(
  vectorActual,
  vectorAnterior,
  reloj,
  mediaLlegadaLavado,
  ...
  if (lavado1.estado === "libre" && lavado2.estado === "libre") {
    ...
    if (rndDestino < 0.5) {
      vectorActual = asignacionLlegadaVehiculoLavado(
        vectorActual,
        reloj,
        mediaFinLavado,
        "1",
    ...
    vectorActual[11] = null; //Fin Lavado 1
    vectorActual[12] = null; //Fin Lavado 2
  }
  ...
  vectorActual[6] = null; //Tiempo de fin lavado
  vectorActual[7] = null; //Tiempo de fin lavado
  ...
  vectorActual.push(JSON.parse(JSON.stringify(vehiculo))); //Agrega el vehiculo al vector
